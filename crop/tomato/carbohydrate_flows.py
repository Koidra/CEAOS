...
def net_photosynthesis_rate(carbohydrate_amount_Buf, carbohydrate_amount_Leaf, outdoor_global_rad, air_CO2, canopy_t):
    ...
    CO2_compensation_point = CO2_compensation(canopy_t)
...
def carbohydrate_flow_from_buffer_to_fruits(carbohydrate_amount_Buf, canopy_t, sum_canopy_t, _24_canopy_t):
    """
    Equations 9.24
    ...
    non_optimal_24_hour_canopy_temperatures_inhibition_rate = non_optimal_24_hour_canopy_temperatures_inhibition(_24_canopy_t)
    crop_development_stage_inhibition_rate = crop_development_stage_inhibition(sum_canopy_t)
    growth_rate = growth_rate_dependency_to_temperature(_24_canopy_t)
...
def carbohydrate_flow_from_buffer_to_leaves(carbohydrate_amount_Buf, _24_canopy_t):
    """
    Equations 9.25
...
def carbohydrate_flow_from_buffer_to_stem(carbohydrate_amount_Buf, _24_canopy_t):
    """
    Equations 9.25
...
def carbohydrate_flow_through_fruit_stages(jth: int, carbohydrate_amount_Fruits, _24_canopy_t):
    """
    Equations 9.34
...
def carbohydrate_flow_from_buffer_to_first_fruit_stage(carbohydrate_amount_Buf, canopy_t, sum_canopy_t, _24_canopy_t):
    """
    Equations 9.35
    ...
    carbohydrate_flow_BufFruits = carbohydrate_flow_from_buffer_to_fruits(carbohydrate_amount_Buf, canopy_t,
                                                                          sum_canopy_t, _24_canopy_t)
    number_flow_BufFruit_1 = fruit_set_of_first_development_stage(_24_canopy_t, carbohydrate_flow_BufFruits)
    W_Pot_Fruit_1 = fruit_growth(1, _24_canopy_t) * FRUIT_DEVELOPMENT_STAGES_NUM
...
def carbohydrate_flow_from_buffer_to_fruit_stages(jth: int, carbohydrate_amount_Buf, number_Fruits, canopy_t,
    ...
    Returns: carbohydrates flow from buffer to fruit stage 1 [mg m^-2 s^-1]
    """
    sum_carbohydrate_flow_BufFruit_conversion_factor = sum_carbohydrate_flow_BufFruit_conversion(number_Fruits, _24_canopy_t)
    number_fruit_j = number_Fruits[jth]
    fruit_growth_rate_j = fruit_growth(jth, _24_canopy_t)
    carbohydrate_flow_BufFruits = carbohydrate_flow_from_buffer_to_fruits(carbohydrate_amount_Buf, canopy_t,
                                                                          sum_canopy_t, _24_canopy_t)
    carbohydrate_flow_BufFruit_1 = carbohydrate_flow_from_buffer_to_first_fruit_stage(carbohydrate_amount_Buf, canopy_t,
                                                                                      sum_canopy_t, _24_canopy_t)
...
def carbohydrate_flow_from_growth_respiration(carbohydrate_amount_Buf, canopy_t, sum_canopy_t, _24_canopy_t):
    """
    Equations 9.43
    ...
    carbohydrate_flow_BufFruits = carbohydrate_flow_from_buffer_to_fruits(carbohydrate_amount_Buf, canopy_t,
                                                                          sum_canopy_t, _24_canopy_t)
    carbohydrate_flow_BufLeaf = carbohydrate_flow_from_buffer_to_leaves(carbohydrate_amount_Buf, _24_canopy_t)
    carbohydrate_flow_BufStem = carbohydrate_flow_from_buffer_to_stem(carbohydrate_amount_Buf, _24_canopy_t)
...
def carbohydrate_flow_from_fruit_maintenance_respiration(carbohydrate_amount_Fruit_j, _24_canopy_t):
    """
    Equations 9.45
    carbohydrate_flow_FruitAir_j = FRUIT_MAINTENANCE_RESPIRATION_COEF * Q10_M**(0.1*(_24_canopy_t-25)) * carbohydrate_amount_Fruit_j
    ...
    """
    return FRUIT_MAINTENANCE_RESPIRATION_COEF * Q10_M**(0.1*(_24_canopy_t-25)) * carbohydrate_amount_Fruit_j \
           * (1 - math.exp(-MAINTENANCE_RESPIRATION_FUNCTION_REGRESSION_COEF*RELATIVE_GROWTH_RATE))


def carbohydrate_flow_from_leaf_maintenance_respiration(carbohydrate_amount_Leaf, _24_canopy_t):
    """
    Equations 9.45
    carbohydrate_flow_LeafAir = LEAF_MAINTENANCE_RESPIRATION_COEF * Q10_M**(0.1*(_24_canopy_t-25)) * carbohydrate_amount_Leaf \
                                * (1 - math.exp(-MAINTENANCE_RESPIRATION_FUNCTION_REGRESSION_COEF*RELATIVE_GROWTH_RATE))
    Returns: carbohydrates flow from leaf maintenance respiration [mg m^-2 s^-1]
    """
    return LEAF_MAINTENANCE_RESPIRATION_COEF * Q10_M**(0.1*(_24_canopy_t-25)) * carbohydrate_amount_Leaf \
           * (1 - math.exp(-MAINTENANCE_RESPIRATION_FUNCTION_REGRESSION_COEF*RELATIVE_GROWTH_RATE))


def carbohydrate_flow_from_stem_maintenance_respiration(carbohydrate_amount_Stem, _24_canopy_t):
    """
    Equations 9.45
    carbohydrate_flow_StemAir = STEM_MAINTENANCE_RESPIRATION_COEF * Q10_M**(0.1*(_24_canopy_t-25)) * carbohydrate_amount_Stem \
                                * (1 - math.exp(-MAINTENANCE_RESPIRATION_FUNCTION_REGRESSION_COEF*RELATIVE_GROWTH_RATE))
    Returns: carbohydrates flow from stem maintenance respiration [mg m^-2 s^-1]
    """
    return STEM_MAINTENANCE_RESPIRATION_COEF * Q10_M**(0.1*(_24_canopy_t-25)) * carbohydrate_amount_Stem \
           * (1 - math.exp(-MAINTENANCE_RESPIRATION_FUNCTION_REGRESSION_COEF*RELATIVE_GROWTH_RATE))
