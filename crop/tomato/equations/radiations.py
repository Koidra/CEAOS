...
def PAR_absorbed_by_canopy():
    ...
    """
    greenhouse_cover_PAR_transmitted = PAR_transmitted_by_greenhouse_cover()
    greenhouse_floor_PAR_reflected = PAR_reflected_by_greenhouse_floor()
    return greenhouse_cover_PAR_transmitted + greenhouse_floor_PAR_reflected


def PAR_transmitted_by_greenhouse_cover():
    """
    Equation 9.18
    ...
    """
    above_canopy_PAR = PAR_above_the_canopy()
    return above_canopy_PAR * (1 - CANOPY_PAR_REFLECTION_COEF) * (1 - math.exp(-CANOPY_PAR_EXTINCTION_COEF*leaf_area_index()))


def PAR_above_the_canopy():
    """
    Equation 9.19
...
def PAR_reflected_by_greenhouse_floor():
    """
    Equation 9.20
